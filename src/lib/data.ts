...
export const pricingData = [
  {
    ...
    modules: 20,
    sinhala: [
      { label: "Full Note Pack (20)", price: 5800, type: "fullNote", buttonText: "Order Now" },
      { label: "Full Assignment Pack (20)", price: 7800, type: "fullAssignment", buttonText: "Order Now" },
      { label: "Note", price: 300, type: "individualNote", buttonText: "Select Item" },
      { label: "Assignment", price: 400, type: "individualAssignment", buttonText: "Select Item" },
      { label: "Note 3", price: 800, type: "partialNote", count: 3, buttonText: "Select Items" },
      { label: "Assignment 3", price: 1100, type: "partialAssignment", count: 3, buttonText: "Select Items" },
      { label: "Note 5", price: 1400, type: "partialNote", count: 5, buttonText: "Select Items" },
      { label: "Assignment 5", price: 1800, type: "partialAssignment", count: 5, buttonText: "Select Items" },
    ],
    english: [
      { label: "Full Note Pack (20)", price: 7800, type: "fullNote", buttonText: "Order Now" },
      { label: "Full Assignment Pack (20)", price: 9800, type: "fullAssignment", buttonText: "Order Now" },
      { label: "Note", price: 400, type: "individualNote", buttonText: "Select Item" },
      { label: "Assignment", price: 500, type: "individualAssignment", buttonText: "Select Item" },
      { label: "Note 3", price: 1100, type: "partialNote", count: 3, buttonText: "Select Items" },
      { label: "Assignment 3", price: 1400, type: "partialAssignment", count: 3, buttonText: "Select Items" },
      { label: "Note 5", price: 1900, type: "partialNote", count: 5, buttonText: "Select Items" },
      { label: "Assignment 5", price: 2400, type: "partialAssignment", count: 5, buttonText: "Select Items" },
    ],
  },
  {
    name: "Beauty",
    modules: 12,
    sinhala: [
        { label: "Full Note Pack (12)", price: 3500, type: "fullNote", buttonText: "Order Now" },
        { label: "Full Assignment Pack (12)", price: 4700, type: "fullAssignment", buttonText: "Order Now" },
        { label: "Note", price: 300, type: "individualNote", buttonText: "Select Item" },
        { label: "Assignment", price: 400, type: "individualAssignment", buttonText: "Select Item" },
        { label: "Note 3", price: 800, type: "partialNote", count: 3, buttonText: "Select Items" },
        { label: "Assignment 3", price: 1100, type: "partialAssignment", count: 3, buttonText: "Select Items" },
    ...
    english: [
        { label: "Full Note Pack (12)", price: 4600, type: "fullNote", buttonText: "Order Now" },
        { label: "Full Assignment Pack (12)", price: 5700, type: "fullAssignment", buttonText: "Order Now" },
        { label: "Note", price: 400, type: "individualNote", buttonText: "Select Item" },
        { label: "Assignment", price: 500, type: "individualAssignment", buttonText: "Select Item" },
        { label: "Note 3", price: 1100, type: "partialNote", count: 3, buttonText: "Select Items" },
        { label: "Assignment 3", price: 1400, type: "partialAssignment", count: 3, buttonText: "Select Items" },
  ...
  },
  {
    ...
    modules: 17,
    sinhala: [
        { label: "Full Note Pack (17)", price: 5000, type: "fullNote", buttonText: "Order Now" },
        { label: "Full Assignment Pack (17)", price: 6600, type: "fullAssignment", buttonText: "Order Now" },
        { label: "Note", price: 300, type: "individualNote", buttonText: "Select Item" },
        { label: "Assignment", price: 400, type: "individualAssignment", buttonText: "Select Item" },
        { label: "Note 3", price: 800, type: "partialNote", count: 3, buttonText: "Select Items" },
        { label: "Assignment 3", price: 1100, type: "partialAssignment", count: 3, buttonText: "Select Items" },
    ...
    english: [
        { label: "Full Note Pack (17)", price: 6600, type: "fullNote", buttonText: "Order Now" },
        { label: "Full Assignment Pack (17)", price: 8300, type: "fullAssignment", buttonText: "Order Now" },
        { label: "Note", price: 400, type: "individualNote", buttonText: "Select Item" },
        { label: "Assignment", price: 500, type: "individualAssignment", buttonText: "Select Item" },
        { label: "Note 3", price: 1100, type: "partialNote", count: 3, buttonText: "Select Items" },
        { label: "Assignment 3", price: 1400, type: "partialAssignment", count: 3, buttonText: "Select Items" },
  ...
  },
  {
    ...
    modules: 2,
    sinhala: [
      { label: "Full Note Pack (2)", price: 600, type: "fullNote", buttonText: "Order Now" },
      { label: "Note", price: 300, type: "individualNote", buttonText: "Select Item" },
    ],
    english: [
      { label: "Full Note Pack (2)", price: 800, type: "fullNote", buttonText: "Order Now" },
      { label: "Note", price: 400, type: "individualNote", buttonText: "Select Item" },
    ],
  },
];
